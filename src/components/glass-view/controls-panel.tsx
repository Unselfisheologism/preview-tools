...
import { Download, Image as ImageIconLucide, Video, Move, Scale as ScaleIcon, RotateCw, CornerRightUp, Chrome, Compass, Layers } from 'lucide-react';
...
const ControlsPanel: React.FC<ControlsPanelProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overlay' | 'background'>('overlay');

  return (
    <div className="space-y-6 h-full flex flex-col">
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'overlay' | 'background')} className="w-full">
